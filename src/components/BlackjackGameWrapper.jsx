...
import BlackjackModern from './BlackjackModern'
  ...
  return (
    <div style={{ 
      ...
      <div style={{ flex: 1, overflow: 'hidden' }}>
        <BlackjackModern demoMode={demoMode && !contractsDeployed} />
      </div>
    </div>
  )
}

export default BlackjackGameWrapper